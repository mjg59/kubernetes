...
const importPrefix = "k8s.io/kubernetes/pkg/apis/tpm"
...
func init() {
	...
	if len(externalVersions) == 0 {
		glog.V(4).Infof("No version is registered for group %v", tpm.GroupName)
		return
	}
